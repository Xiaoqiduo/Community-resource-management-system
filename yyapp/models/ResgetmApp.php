...
class ResgetmApp extends CI_Model {
	...
	public function getResourcesState($resource_id,$community_id){
		$query = $this->db->query("SELECT * FROM ((resource JOIN resource_type ON resource_type.res_type_id = resource.res_id)JOIN community ON community.cmty_id = resource.cmty_id) WHERE resource.res_type_id = ".$resource_id." AND community.cmty_id = ".$community_id."");
